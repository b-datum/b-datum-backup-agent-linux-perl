...
# cd /tmp
# wget https://github.com/b-datum/b-datum-backup-agent-linux-perl/releases/download/0.18/b-datum-backup-perl_0.18-1_all.deb
# gdebi b-datum-backup-perl_0.18-1_all.deb
```

...
# cd /tmp
# wget https://github.com/b-datum/b-datum-linux/releases/download/1.02/b-datum-backup-perl_1.02-1_all.deb
# gdebi b-datum-backup-perl_1.02-1_all.deb
```
...
```
# cd /tmp
# wget https://github.com/b-datum/b-datum-linux/releases/download/1.02/b-datum-linux-1.02-1.el6.x86_64.rpm
# rpm -Uvh b-datum-linux-1.02-1.el6.x86_64.rpm
```

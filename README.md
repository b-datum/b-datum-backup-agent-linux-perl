...
# cd /tmp
# wget https://github.com/b-datum/b-datum-backup-agent-linux-perl/releases/download/0.04/b-datum-backup-perl_0.04-1_all.deb
# gdebi b-datum-backup-perl_0.04-1_all.deb
```
